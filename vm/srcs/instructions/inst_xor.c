...
/*   By: gly <marvin@42.fr>                         +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/03 14:55:40 by gly               #+#    #+#             */
/*   Updated: 2019/09/03 14:55:41 by gly              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** The xor instruction apply an ^ (bit-to-bit XOR).
...
** There's a coding byte for the arguments and its opcode is 0x08.
*/
